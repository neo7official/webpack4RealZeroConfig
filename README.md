...
All options has been enlisted to **config/public.options.js** file. Check this file. All the options are quite self explanatory and has comments with all options.
